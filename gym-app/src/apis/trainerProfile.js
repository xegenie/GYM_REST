...
// 목록 조회
export const list = (keyword) => api.get(`/admin/trainer/list?keyword=${keyword}`)

// 트레이너 상세 조회
export const select = (no) => api.get(`/admin/trainer/select?no=${no}`)
...
//트레이너 삭제
export const remove = (no) => api.delete(`/admin/trainer/delete?no=${no}`)